-- OC Participation - 7 Day Count
-- 
-- Purpose: Count the number of OC participations per member in the last 7 days
-- 
-- Outputs:
--   - member_id: Member ID
--   - member_name: Member name
--   - oc_count_7d: Number of OCs participated in the last 7 days
--   - last_oc_date: Date of most recent OC participation
--
-- Usage: Run this query to get recent OC participation counts for member prioritization
